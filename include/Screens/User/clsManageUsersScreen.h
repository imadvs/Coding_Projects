...
#ifndef PROJECT1L4BANKEXTENSION2_MANAGE_USERS_SCREEN_H
#define PROJECT1L4BANKEXTENSION2_MANAGE_USERS_SCREEN_H
...
private:
    ...
    {
        cout << "\n\nPress any key to go back to Manage User.txt Menue...";
        _PauseScreen();
    ...
    {
        //cout << "\nList User.txt Screen Will Be Here.\n";
...
public:
    static void ShowManageUsersMenue()
    {
        ...
        _ClearScreen();
        _DrawScreenHeader("\t Manage User.txt Screen");

        cout << setw(37) << left << "" << "===========================================\n";
        cout << setw(37) << left << "" << "\t\t  Manage User.txt Menue\n";
        cout << setw(37) << left << "" << "===========================================\n";
        cout << setw(37) << left << "" << "\t[1] List User.txt.\n";
